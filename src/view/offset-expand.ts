...
import { type Direction4, OpenAble } from "./std.js";
import { htmlSlot, type HTMLTemplate } from "../lib/templates.js";
import { debounce } from "../lib/utils.js";
import { define } from "../root.js";

const defineName = "offset-expand";

/**
 * OffsetExpand will calculate a lateral offset to try to keep the content within the allowable range.
 *
 * Content can be opened in 4 directions.
 */
@define(defineName)
export class OffsetExpand extends OpenAble {
...
export default OffsetExpand;

declare global {
  interface HTMLElementTagNameMap {
    "offset-expand": OffsetExpand;
  }
}
